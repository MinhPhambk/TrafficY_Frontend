...
```sh
git clone https://github.com/MinhPhambk/TrafficY_Frontend.git
```

### 📌 5️⃣ Truy cập vào thư mục dự án

```sh
cd TrafficY_Frontend
```
...
🐞 Báo lỗi: [🔗 Issues trên GitHub](https://github.com/MinhPhambk/TrafficY_Frontend/issues)  

🎯 **TrafficY - Công nghệ giao thông thông minh, an toàn hơn mỗi ngày!**
